...
import com.mangala.autofill.domain.javascript.JavascriptCredentials
import com.mangala.autofill.jsbridge.AutofillMessagePoster
import com.mangala.autofill.jsbridge.request.AutofillDataRequest
import com.mangala.autofill.jsbridge.request.AutofillRequestParser
import com.mangala.autofill.jsbridge.request.SupportedAutofillInputMainType.CREDENTIALS
import com.mangala.autofill.jsbridge.request.SupportedAutofillInputSubType.PASSWORD
import com.mangala.autofill.jsbridge.request.SupportedAutofillInputSubType.USERNAME
...
class AutofillStoredBackJavascriptInterface (
    ...
    class WebViewUrlProvider (val dispatcherProvider: DispatcherProvider) :
        UrlProvider {
