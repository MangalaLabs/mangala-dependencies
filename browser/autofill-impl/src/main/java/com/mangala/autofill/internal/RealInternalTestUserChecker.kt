...
package com.mangala.autofill.internal

import androidx.core.net.toUri
import com.mangala.appbuildconfig.api.AppBuildConfig
import com.mangala.appbuildconfig.api.isInternalBuild
 ...
 */
class RealInternalTestUserChecker(
    ...
    companion object {
        private const val LOGIN_URL_SUCCESS = ""
    }
}
