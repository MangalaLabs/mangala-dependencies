...
package com.mangala.autofill.jsbridge.request
...
class AutofillJsonRequestParser (val moshi: Moshi) : AutofillRequestParser {

    private val autofillDataRequestParser by lazy { moshi.adapter(AutofillDataRequest::class.java) }
    private val autofillStoreFormDataRequestParser by lazy { moshi.adapter(
        AutofillStoreFormDataRequest::class.java) }
