...
import com.mangala.appbuildconfig.api.BuildFlavor.INTERNAL
...
class AndroidAppAttributeMatcherTest {
    ...
    fun whenAppIdMatchesThenReturnMatch() = runTest {
        givenDeviceProperties(appId = "com.mangala.mobile.android")

        val result = testee.evaluate(
            MatchingAttribute.AppId(value = "com.mangala.mobile.android")
        )
    ...
    private fun givenDeviceProperties(
        ...
        appId: String = "com.mangala.mobile.android.debug",
