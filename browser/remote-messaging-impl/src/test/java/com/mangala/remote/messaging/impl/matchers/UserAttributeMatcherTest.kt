...
import com.mangala.remote.messaging.impl.models.MatchingAttribute.Favorites
...
class UserAttributeMatcherTest {
    ...
    fun whenAppThemeMatchesThenReturnMatch() = runBlocking {
        givenBrowserProperties(appTheme = MangalaTheme.SYSTEM_DEFAULT)
    ...
    private suspend fun givenBrowserProperties(
        appTheme: MangalaTheme = MangalaTheme.SYSTEM_DEFAULT,
        bookmarks: Long = 8L,
        favorites: Long = 8L,
