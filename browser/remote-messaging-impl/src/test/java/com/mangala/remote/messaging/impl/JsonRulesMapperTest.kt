...
import com.mangala.remote.messaging.impl.mappers.mapToMatchingRules
import com.mangala.remote.messaging.impl.models.JsonMatchingAttribute
import com.mangala.remote.messaging.impl.models.JsonMatchingRule
...
class JsonRulesMapperTest(private val testCase: TestCase) {
    ...
    companion object {
        ...
        fun parameters() = arrayOf(
            ...
            TestCase(
                givenJsonRule(
                    Pair("appId", JsonMatchingAttribute(value = "com.mangala.mobile.android.debug")),
                ...
                matchingRule(
                    MatchingAttribute.AppId(value = "com.mangala.mobile.android.debug"),
            ...
            TestCase(
                givenJsonRule(
                    Pair("appId", JsonMatchingAttribute(value = "com.mangala.mobile.android.debug", fallback = true)),
                ...
                matchingRule(
                    MatchingAttribute.AppId(value = "com.mangala.mobile.android.debug", fallback = true),
