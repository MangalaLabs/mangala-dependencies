...
import com.mangala.macos_impl.databinding.ActivityMacosWaitlistBinding
import com.mangala.macos_impl.waitlist.ui.MacOsWaitlistViewModel.Command
import com.mangala.macos_impl.waitlist.ui.MacOsWaitlistViewModel.Command.CopyInviteToClipboard
import com.mangala.macos_impl.waitlist.ui.MacOsWaitlistViewModel.Command.ShareInviteCode
import com.mangala.macos_impl.waitlist.ui.MacOsWaitlistViewModel.Command.ShowErrorMessage
import com.mangala.macos_impl.waitlist.ui.MacOsWaitlistViewModel.ViewState
import com.mangala.macos_store.MacOsWaitlistState.InBeta
import com.mangala.macos_store.MacOsWaitlistState.JoinedWaitlist
import com.mangala.macos_store.MacOsWaitlistState.NotJoinedQueue
import com.mangala.mobile.android.ui.spans.MangalaClickableSpan
import com.mangala.mobile.android.ui.view.addClickableSpan
...
//@AndroidEntryPoint
class MacOsWaitlistActivity : MangalaBrowserActivity(), KoinComponent {

//    @Inject
    val clipboardManager: ClipboardManager by inject()

    private val viewModel: MacOsWaitlistViewModel by viewModels()
    private val binding: ActivityMacosWaitlistBinding by viewBinding()

    private val toolbar
        get() = binding.includeToolbar.findViewById<Toolbar>(com.mangala.mobile.android.R.id.toolbar)

    private val macOsSpan = object : MangalaClickableSpan() {
    ...
    private fun renderNotJoinedQueue() {
        binding.headerImage.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_privacy_simplified)
