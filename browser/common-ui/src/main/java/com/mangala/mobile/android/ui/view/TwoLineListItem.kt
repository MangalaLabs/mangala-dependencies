...
import com.mangala.mobile.android.databinding.ViewTwoLineItemBinding
...
class TwoLineListItem : LinearLayout {
    ...
    constructor(
        context: Context,
        attrs: AttributeSet?
    ) : this(context, attrs, R.style.Widget_Mangala_TwoLineListItem)
    ...
    constructor(
        ...
        setImageResource(
            attributes.getResourceId(
                R.styleable.TwoLineListItem_twoLineItemDrawable, com.schoolonair.wallet.component.resources.R.drawable.ic_overflow_browser
            )
        )
        attributes.recycle()
    }
