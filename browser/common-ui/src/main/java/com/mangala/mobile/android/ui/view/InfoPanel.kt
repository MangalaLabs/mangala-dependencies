...
import com.mangala.mobile.android.databinding.ViewInfoPanelBinding
...
class InfoPanel : FrameLayout {
    ...
    constructor(
        ...
        context,
        attrs,
        R.style.Widget_Mangala_InfoPanel
    )
    ...
    constructor(
        ...
        setImageResource(
            attributes.getResourceId(
                ...
                com.schoolonair.wallet.component.resources.R.drawable.ic_link_color_24
            )
        )
        setBackgroundResource(
            attributes.getResourceId(
                R.styleable.InfoPanel_panelBackground,
                com.schoolonair.wallet.component.resources.R.drawable.info_panel_tooltip_background
            )
        )
        attributes.recycle()
    }
    ...
    fun setClickableLink(
        ...
        annotations?.find { it.value == annotation }?.let {
            spannableString.apply {
                ...
                setSpan(
                    ForegroundColorSpan(context.getColorFromAttr(com.schoolonair.wallet.component.resources.R.attr.normalTextColor)),
                    fullText.getSpanStart(it),
                    fullText.getSpanEnd(it),
                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE
                )
