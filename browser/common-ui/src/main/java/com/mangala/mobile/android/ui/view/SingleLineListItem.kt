...
import com.mangala.mobile.android.databinding.ViewSingleLineListItemBinding
...
class SingleLineListItem : LinearLayout {
    ...
    constructor(
        context: Context,
        attrs: AttributeSet?
    ) : this(context, attrs, R.style.Widget_Mangala_SingleLineListItem)
    ...
    constructor(
        ...
        setImageResource(
            attributes.getResourceId(
                R.styleable.SingleLineListItem_singleLineItemDrawable, com.schoolonair.wallet.component.resources.R.drawable.ic_overflow_browser
            )
        )
        attributes.recycle()
    }
