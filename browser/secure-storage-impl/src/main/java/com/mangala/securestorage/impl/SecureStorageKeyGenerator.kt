...
class RealSecureStorageKeyGenerator (
    private val appBuildConfig: AppBuildConfig,
//    @Named("DerivedKeySecretFactoryFor26Up")
    private val derivedKeySecretFactory: DerivedKeySecretFactory,
//    @Named("DerivedKeySecretFactoryForLegacy")
    private val legacyDerivedKeySecretFactory: DerivedKeySecretFactory,
    ...
    override fun generateKeyFromPassword(
        ...
        if (appBuildConfig.sdkInt >= Build.VERSION_CODES.O) {
            derivedKeySecretFactory.getKey(
                PBEKeySpec(
            ...
            legacyDerivedKeySecretFactory.getKey(
                PBEKeySpec(
                    password.toCharArray(),
                    salt,
                    ITERATIONS_LEGACY,
