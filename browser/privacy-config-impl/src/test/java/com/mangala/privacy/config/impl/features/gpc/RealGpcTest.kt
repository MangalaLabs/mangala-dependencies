...
import com.mangala.privacy.config.impl.features.gpc.RealGpc.Companion.GPC_HEADER
import com.mangala.privacy.config.impl.features.gpc.RealGpc.Companion.GPC_HEADER_VALUE
...
class RealGpcTest {
    ...
    fun setup() {
        ...
        val headers =
            CopyOnWriteArrayList<GpcHeaderEnabledSite>().apply { add(GpcHeaderEnabledSite(
                VALID_CONSUMER_URL
            )) }
