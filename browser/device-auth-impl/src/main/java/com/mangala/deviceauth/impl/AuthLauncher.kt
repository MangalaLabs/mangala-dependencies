...
import com.mangala.deviceauth.api.DeviceAuthenticator.AuthResult.Error
...
class RealAuthLauncher(
    private val context: Context,
    private val appBuildConfig: AppBuildConfig
) : AuthLauncher {
    private val biometricPromptInfoBuilder by lazy {
        BiometricPrompt.PromptInfo.Builder()
            .setTitle(context.getString(com.schoolonair.wallet.component.resources.R.string.biometric_prompt_title))
    }
