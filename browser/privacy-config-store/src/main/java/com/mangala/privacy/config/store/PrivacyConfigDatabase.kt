...
package com.mangala.privacy.config.store
...
import com.mangala.privacy.config.store.features.autofill.AutofillDao
import com.mangala.privacy.config.store.features.contentblocking.ContentBlockingDao
import com.mangala.privacy.config.store.features.drm.DrmDao
import com.mangala.privacy.config.store.features.gpc.GpcExceptionsDao
import com.mangala.privacy.config.store.features.gpc.GpcHeadersDao
import com.mangala.privacy.config.store.features.https.HttpsDao
import com.mangala.privacy.config.store.features.trackerallowlist.TrackerAllowlistDao
import com.mangala.privacy.config.store.features.amplinks.AmpLinksDao
import com.mangala.privacy.config.store.features.trackingparameters.TrackingParametersDao
import com.mangala.privacy.config.store.features.unprotectedtemporary.UnprotectedTemporaryDao
import com.mangala.privacy.config.store.features.useragent.UserAgentDao
