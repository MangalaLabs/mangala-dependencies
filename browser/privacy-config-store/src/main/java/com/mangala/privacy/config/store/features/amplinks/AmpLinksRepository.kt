...
package com.mangala.privacy.config.store.features.amplinks

import com.mangala.app.global.DispatcherProvider
import com.mangala.privacy.config.api.AmpLinkException
import com.mangala.privacy.config.store.AmpKeywordEntity
import com.mangala.privacy.config.store.AmpLinkExceptionEntity
import com.mangala.privacy.config.store.AmpLinkFormatEntity
import com.mangala.privacy.config.store.PrivacyConfigDatabase
import com.mangala.privacy.config.store.toAmpLinkException
