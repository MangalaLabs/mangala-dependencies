...
package com.mangala.privacy.config.store.features.trackingparameters

import com.mangala.app.CoroutineTestRule
import com.mangala.privacy.config.store.PrivacyConfigDatabase
import com.mangala.privacy.config.store.TrackingParameterEntity
import com.mangala.privacy.config.store.TrackingParameterExceptionEntity
import com.mangala.privacy.config.store.toTrackingParameterException
...
class RealTrackingParametersRepositoryTest {
    ...
    private fun givenTrackingParametersDaoContainsEntities() {
        whenever(mockTrackingParametersDao.getAllExceptions()).thenReturn(listOf(
            trackingParameterExceptionEntity
        ))
        whenever(mockTrackingParametersDao.getAllTrackingParameters()).thenReturn(listOf(
