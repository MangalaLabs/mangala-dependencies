...
package com.mangala.app.dev.settings
...
import com.mangala.app.dev.settings.DevSettingsViewModel.Command
import com.mangala.app.dev.settings.db.UAOverride
import com.mangala.app.dev.settings.privacy.TrackerDataDevReceiver.Companion.DOWNLOAD_TDS_INTENT_ACTION
...
import com.schoolonair.wallet.browser.app.databinding.ActivityDevSettingsBinding
...
@AndroidEntryPoint
class DevSettingsActivity : MangalaBrowserActivity() {
