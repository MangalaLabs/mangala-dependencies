...
package com.mangala.app.dev.settings.db
...
class DevSettingsSharedPreferences @Inject constructor(@ApplicationContext private val context: Context) :
    ...
    companion object {
        const val FILENAME = "com.mangala.app.dev_settings_activity.dev_settings"
