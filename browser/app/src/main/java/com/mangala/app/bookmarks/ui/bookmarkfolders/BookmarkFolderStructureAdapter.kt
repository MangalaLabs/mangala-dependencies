...
import com.schoolonair.wallet.browser.app.databinding.ItemBookmarkFolderBinding
...
class FolderViewHolder(
    ...
    fun bind(item: BookmarkFolderItem) {
        ...
        if (item.isSelected) {
            binding.icon.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_check)
            binding.iconContainer.setBackgroundResource(com.schoolonair.wallet.component.resources.R.drawable.selected_icon_background)
        } else {
            binding.icon.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_folder)
            binding.iconContainer.setBackgroundResource(com.schoolonair.wallet.component.resources.R.drawable.list_item_image_background)
        }
