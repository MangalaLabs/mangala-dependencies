...
package com.mangala.app.global.rating

import android.content.Context
import com.mangala.app.global.rating.AppEnjoymentPromptOptions.ShowEnjoymentPrompt
import com.mangala.app.global.rating.AppEnjoymentPromptOptions.ShowNothing
...
class InitialPromptTypeDecider(
    ...
    private fun wasInstalledThroughPlayStore(): Boolean {
        if (!playStoreUtils.installedFromPlayStore()) {
            Timber.i("Mangala was not installed from Play Store")
