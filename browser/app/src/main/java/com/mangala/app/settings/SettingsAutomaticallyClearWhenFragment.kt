...
class SettingsAutomaticallyClearWhenFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val alertBuilder = AlertDialog.Builder(requireActivity())
            .setView(rootView)
            .setTitle(com.schoolonair.wallet.component.resources.R.string.settingsAutomaticallyClearWhenDialogTitle)
            .setPositiveButton(com.schoolonair.wallet.component.resources.R.string.settingsAutomaticallyClearingDialogSave) { _, _ ->
                dialog?.let {
