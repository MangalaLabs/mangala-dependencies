...
class EmailProtectionSignInViewModel (
    ...
    companion object {
        const val ADDRESS_BLOG_POST = "https://mangala.com/email/learn-more"
        const val GET_STARTED_URL = "https://mangala.com/email/start?inviteCode="
        const val SIGN_UP_URL = "https://mangala.com/email/signup?inviteCode="
        const val LOGIN_URL = "https://mangala.com/email/login"
    }
}
