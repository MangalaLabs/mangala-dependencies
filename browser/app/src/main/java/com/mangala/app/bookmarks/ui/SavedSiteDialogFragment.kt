...
import com.mangala.app.bookmarks.ui.bookmarkfolders.BookmarkFoldersActivity
import com.mangala.app.bookmarks.ui.bookmarkfolders.BookmarkFoldersActivity.Companion.KEY_BOOKMARK_FOLDER_ID
import com.mangala.app.bookmarks.ui.bookmarkfolders.BookmarkFoldersActivity.Companion.KEY_BOOKMARK_FOLDER_NAME
import com.mangala.app.bookmarks.ui.bookmarkfolders.BookmarkFoldersActivity.Companion.KEY_CURRENT_FOLDER
...
import com.schoolonair.wallet.browser.app.databinding.DialogFragmentSavedSiteBinding
...
abstract class SavedSiteDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        configureToolbar(binding.root.findViewById(R.id.toolbar))
        configureUI()
    ...
    protected fun setConfirmationVisibility(inputState: ValidationState = ValidationState.UNCHANGED) {
        binding.root.findViewById<Toolbar>(R.id.toolbar).menu.findItem(R.id.action_confirm_changes).isVisible =
