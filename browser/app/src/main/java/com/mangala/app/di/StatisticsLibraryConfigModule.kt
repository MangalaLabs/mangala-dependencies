...
import com.mangala.app.statistics.config.DefaultStatisticsLibraryConfig
...
val statisticsLibraryConfigModule = module {
    single {
        DefaultStatisticsLibraryConfig(
            get<AppBuildConfig>()
        ) as StatisticsLibraryConfig
    }
}
