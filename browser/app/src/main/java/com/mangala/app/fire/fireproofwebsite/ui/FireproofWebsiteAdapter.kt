...
import com.mangala.app.fire.fireproofwebsite.ui.FireproofWebsitesViewModel.Command.ShowAutomaticFireproofSettingSelectionDialog
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            ...
            SECTION_TITLE_TYPE -> {
                ...
                binding.fireproofWebsiteSectionTitle.setText(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteItemsSectionTitle)
                FireproofWebSiteViewHolder.FireproofWebsiteSimpleViewViewHolder(binding)
            }
