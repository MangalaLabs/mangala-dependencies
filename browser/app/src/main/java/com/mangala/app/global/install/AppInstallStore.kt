...
package com.mangala.app.global.install
...
class AppInstallSharedPreferences ( private val context: Context) :
    AppInstallStore {
    ...
    companion object {
        @VisibleForTesting
        const val FILENAME = "com.mangala.app.install.settings"
