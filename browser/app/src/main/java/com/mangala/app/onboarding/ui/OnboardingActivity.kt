...
import com.schoolonair.wallet.browser.app.databinding.ActivityOnboardingBinding
import org.koin.androidx.viewmodel.ext.android.viewModel

class OnboardingActivity : MangalaBrowserActivity() {
    ...
    fun onOnboardingDone() {
        ...
        startActivity(BrowserActivityNavigationUtils.intent(this@OnboardingActivity))
        finish()
    }
