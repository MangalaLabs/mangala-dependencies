...
class FeatureTogglesPluginPointPluginPoint (
): PluginPoint<FeatureTogglesPlugin>, KoinComponent {
    ...
    override fun getPlugins(): Collection<FeatureTogglesPlugin> {
        Timber.d("1991 FeatureTogglesPluginPointPluginPoint")
        return listOf(privacyFeatureTogglesPlugin)
    }
}
