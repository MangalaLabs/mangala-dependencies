...
class SettingsFireAnimationSelectorFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val alertBuilder = AlertDialog.Builder(requireActivity())
            .setView(rootView)
            .setTitle(com.schoolonair.wallet.component.resources.R.string.settingsSelectFireAnimationDialog)
            .setPositiveButton(com.schoolonair.wallet.component.resources.R.string.settingsSelectFireAnimationDialogSave) { _, _ ->
                dialog?.let {
