...
package com.mangala.app.browser.autofill
...
import com.mangala.deviceauth.api.DeviceAuthenticator.AuthResult.Success
import com.mangala.deviceauth.api.DeviceAuthenticator.Features.AUTOFILL
import timber.log.Timber

class AutofillCredentialsSelectionResultHandler(private val deviceAuthenticator: DeviceAuthenticator) {
    ...
    fun processUpdateCredentialsResult(result: Bundle, credentialSaver: AutofillCredentialSaver) {
        val selectedCredentials = result.getParcelable<LoginCredentials>(
            CredentialUpdateExistingCredentialsDialog.KEY_CREDENTIALS) ?: return
