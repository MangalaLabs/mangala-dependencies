...
import com.schoolonair.wallet.browser.app.databinding.DialogRadioGroupSelectorFragmentBinding
...
class FireproofSettingsSelectorFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val alertBuilder = MaterialAlertDialogBuilder(requireActivity())
            ...
            .setTitle(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingSelectionTitle)
    ...
    private fun setRadioButtonOptions(binding: DialogRadioGroupSelectorFragmentBinding) {
        binding.selectorRadioButton1.setText(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogAskEveryTime)
        binding.selectorRadioButton2.setText(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogAlways)
        binding.selectorRadioButton3.setText(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogNever)
    }
