...
import com.mangala.app.global.AppUrl.ParamValue
...
class MangalaRequestRewriter(
    ...
    override fun shouldRewriteRequest(uri: Uri): Boolean {
        return (mangalaUrlDetector.isMangalaQueryUrl(uri.toString()) || mangalaUrlDetector.isMangalaStaticUrl(uri.toString())) &&
