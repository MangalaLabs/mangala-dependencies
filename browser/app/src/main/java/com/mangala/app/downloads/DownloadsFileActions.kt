...
class DownloadsFileActions(private val appBuildConfig: AppBuildConfig) {
    ...
    private fun createShareIntent(applicationContext: Context, file: File): Intent? {
        ...
        return Intent.createChooser(
            intent, applicationContext.getString(com.schoolonair.wallet.component.resources.R.string.downloadsShareTitle)
        )
            .apply {
