...
import com.mangala.app.onboarding.store.daxOnboardingActive
...
//            }
    ...
    private fun getDaxDialogCta(site: Site?): Cta? {
        ...
        nonNullSite.let {
            ...
            if (mangalaUrlDetector.isMangalaEmailUrl(it.url)) {
                return null
            }
        ...
        .onEach { (_, forceStopAnimation) ->
            withContext(dispatchers.io()) {
                if (pulseAnimationDisabled()) {
                    isFireButtonPulseAnimationFlowEnabled.value = false
                }
