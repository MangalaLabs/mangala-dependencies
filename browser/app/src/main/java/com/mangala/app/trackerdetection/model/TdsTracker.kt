...
package com.mangala.app.trackerdetection.model
...
object Adapters {
    ...
    lateinit var instance: Adapters

    lateinit var ruleListAdapter: JsonAdapter<List<Rule>>
    lateinit var stringListAdapter: JsonAdapter<List<String>>

    fun initialize(moshi: Moshi) {
        val ruleListType = Types.newParameterizedType(List::class.java, Rule::class.java)
        val stringListType = Types.newParameterizedType(List::class.java, String::class.java)
        ruleListAdapter = moshi.adapter(ruleListType)
        stringListAdapter = moshi.adapter(stringListType)
    }
//    companion object {
