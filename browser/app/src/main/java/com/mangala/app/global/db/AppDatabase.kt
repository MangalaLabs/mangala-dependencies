...
package com.mangala.app.global.db
...
import com.mangala.app.bookmarks.db.*
import com.mangala.app.browser.cookies.db.AuthCookiesAllowedDomainsDao
import com.mangala.app.browser.cookies.db.AuthCookieAllowedDomainEntity
import com.mangala.app.browser.rating.db.*
import com.mangala.app.cta.db.DismissedCtaDao
import com.mangala.app.cta.model.DismissedCta
...
import com.mangala.app.global.events.db.UserEventEntity
import com.mangala.app.global.events.db.UserEventTypeConverter
import com.mangala.app.global.events.db.UserEventsDao
import com.mangala.app.global.exception.UncaughtExceptionDao
import com.mangala.app.global.exception.UncaughtExceptionEntity
import com.mangala.app.global.exception.UncaughtExceptionSourceConverter
...
import com.mangala.app.location.data.LocationPermissionsDao
import com.mangala.app.notification.db.NotificationDao
import com.mangala.app.notification.model.Notification
import com.mangala.app.onboarding.store.*
import com.mangala.app.privacy.db.*
import com.mangala.app.privacy.model.PrivacyProtectionCountsEntity
import com.mangala.app.privacy.model.UserWhitelistedDomain
import com.mangala.app.settings.db.SettingsDataStore
import com.mangala.app.settings.db.SettingsSharedPreferences.LoginDetectorPrefsMapper
import com.mangala.app.statistics.model.PixelEntity
import com.mangala.app.statistics.model.QueryParamsTypeConverter
import com.mangala.app.statistics.store.PendingPixelDao
import com.mangala.app.survey.db.SurveyDao
import com.mangala.app.survey.model.Survey
import com.mangala.app.tabs.db.TabsDao
import com.mangala.app.tabs.model.TabEntity
import com.mangala.app.tabs.model.TabSelectionEntity
import com.mangala.app.trackerdetection.db.*
import com.mangala.app.trackerdetection.model.*
import com.mangala.app.usage.app.AppDaysUsedDao
import com.mangala.app.usage.app.AppDaysUsedEntity
import com.mangala.app.usage.search.SearchCountDao
import com.mangala.app.usage.search.SearchCountEntity
import com.mangala.app.bookmarks.db.BookmarkEntity
import com.mangala.app.bookmarks.db.BookmarkFolderEntity
import com.mangala.app.bookmarks.db.BookmarkFoldersDao
import com.mangala.app.bookmarks.db.BookmarksDao
import com.mangala.app.bookmarks.db.FavoriteEntity
import com.mangala.app.bookmarks.db.FavoritesDao
import com.mangala.app.browser.rating.db.AppEnjoymentDao
import com.mangala.app.browser.rating.db.AppEnjoymentEntity
import com.mangala.app.browser.rating.db.AppEnjoymentTypeConverter
import com.mangala.app.browser.rating.db.LocationPermissionTypeConverter
import com.mangala.app.browser.rating.db.PromptCountConverter
import com.mangala.app.onboarding.store.AppStage
import com.mangala.app.onboarding.store.StageTypeConverter
import com.mangala.app.onboarding.store.USER_STAGE_TABLE_NAME
import com.mangala.app.onboarding.store.UserStage
import com.mangala.app.onboarding.store.UserStageDao
...
import com.mangala.app.privacy.db.SitesVisitedEntity
...
import com.mangala.app.trackerdetection.model.ActionTypeConverter
import com.mangala.app.trackerdetection.model.CategoriesTypeConverter
import com.mangala.app.trackerdetection.model.RuleTypeConverter
...
import com.schoolonair.wallet.local.walletconnect.DatabaseConverters
import com.schoolonair.wallet.local.walletconnect.WC1SessionDao
import com.schoolonair.wallet.local.walletconnect.WC2SessionDao
import com.schoolonair.wallet.local.walletconnect.WCSignElement
import com.schoolonair.wallet.local.walletconnect.WCSignElementDao
import com.schoolonair.wallet.local.walletconnect.WalletConnectSession
import com.schoolonair.wallet.local.walletconnect.WalletConnectV2Session
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun wcSignElementDao(): WCSignElementDao
...
class MigrationsProvider(val context: Context, val settingsDataStore: SettingsDataStore) {
    ...
    val MIGRATION_43_TO_44: Migration = object : Migration(43, 44) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL("ALTER TABLE `tabs` ADD COLUMN `accountId` TEXT")
            database.execSQL("ALTER TABLE `tabs` ADD COLUMN `chainId` INTEGER")
        }
    }
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(expression = "UserStageStore", imports = ["com.mangala.app.onboarding.store"])
    )
    private inner class OldOnboardingStore {
        private val fileName = "com.mangala.app.onboarding.settings"
        private val keyVersion = "com.mangala.app.onboarding.currentVersion"
