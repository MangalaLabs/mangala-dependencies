...
class WebViewLongPressHandler(
    ...
    override fun handleLongPress(
        ...
        menu.setHeaderTitle(longPressTargetUrl?.take(MAX_TITLE_LENGTH) ?: context.getString(com.schoolonair.wallet.component.resources.R.string.options))
    ...
    private fun addImageMenuOptions(menu: ContextMenu) {
        menu.add(0, CONTEXT_MENU_ID_DOWNLOAD_IMAGE, CONTEXT_MENU_ID_DOWNLOAD_IMAGE, com.schoolonair.wallet.component.resources.R.string.downloadImage)
        menu.add(0, CONTEXT_MENU_ID_OPEN_IMAGE_IN_NEW_BACKGROUND_TAB, CONTEXT_MENU_ID_OPEN_IMAGE_IN_NEW_BACKGROUND_TAB, com.schoolonair.wallet.component.resources.R.string.openImageInNewTab)
    }

    private fun addLinkMenuOptions(menu: ContextMenu) {
        menu.add(0, CONTEXT_MENU_ID_OPEN_IN_NEW_TAB, CONTEXT_MENU_ID_OPEN_IN_NEW_TAB, com.schoolonair.wallet.component.resources.R.string.openInNewTab)
        menu.add(0, CONTEXT_MENU_ID_OPEN_IN_NEW_BACKGROUND_TAB, CONTEXT_MENU_ID_OPEN_IN_NEW_BACKGROUND_TAB, com.schoolonair.wallet.component.resources.R.string.openInNewBackgroundTab)
        menu.add(0, CONTEXT_MENU_ID_COPY, CONTEXT_MENU_ID_COPY, com.schoolonair.wallet.component.resources.R.string.copyUrl)
        menu.add(0, CONTEXT_MENU_ID_SHARE_LINK, CONTEXT_MENU_ID_SHARE_LINK, com.schoolonair.wallet.component.resources.R.string.shareLink)
    }
