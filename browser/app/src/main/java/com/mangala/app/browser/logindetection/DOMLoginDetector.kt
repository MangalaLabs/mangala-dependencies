...
import com.mangala.app.browser.logindetection.LoginDetectionJavascriptInterface.Companion.JAVASCRIPT_INTERFACE_NAME
...
class JsLoginDetector (private val settingsDataStore: SettingsDataStore) :
    DOMLoginDetector {
