...
import com.mangala.app.httpsupgrade.store.EmptyHttpsEmbeddedDataPersister
...
val httpsPersisterModule = module {
    single<HttpsEmbeddedDataPersister> {
        EmptyHttpsEmbeddedDataPersister()
    }
}