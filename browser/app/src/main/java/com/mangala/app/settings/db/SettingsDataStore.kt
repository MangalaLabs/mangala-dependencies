...
package com.mangala.app.settings.db
...
import com.mangala.app.settings.db.SettingsSharedPreferences.LoginDetectorPrefsMapper.AutomaticFireproofSetting.NEVER
...
class SettingsSharedPreferences (
    ...
    override var automaticFireproofSetting: AutomaticFireproofSetting
        get() = AutomaticFireproofSetting.valueOf(preferences.getString(
            KEY_AUTOMATIC_FIREPROOF_SETTING, ASK_EVERY_TIME.name) ?: ASK_EVERY_TIME.name)
    ...
    override fun hasBackgroundTimestampRecorded(): Boolean = preferences.contains(
        KEY_APP_BACKGROUNDED_TIMESTAMP
    )
    override fun clearAppBackgroundTimestamp() = preferences.edit { remove(
        KEY_APP_BACKGROUNDED_TIMESTAMP
    ) }
    ...
    class LoginDetectorPrefsMapper {
        enum class AutomaticFireproofSetting(val stringRes: Int) {
            ASK_EVERY_TIME(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogAskEveryTime),
            ALWAYS(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogAlways),
            NEVER(com.schoolonair.wallet.component.resources.R.string.fireproofWebsiteSettingsSelectionDialogNever)
        }
