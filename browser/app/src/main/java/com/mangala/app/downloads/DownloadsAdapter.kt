...
import com.mangala.app.downloads.DownloadViewItem.Empty
import com.mangala.app.downloads.DownloadViewItem.Header
import com.mangala.app.downloads.DownloadViewItem.Item
import com.mangala.app.global.formatters.data.DataSizeFormatter
...
import com.schoolonair.wallet.browser.app.databinding.ViewItemDownloadsEmptyBinding
import com.schoolonair.wallet.browser.app.databinding.ViewItemDownloadsHeaderBinding
import com.schoolonair.wallet.browser.app.databinding.ViewItemDownloadsItemBinding
...
class DownloadsAdapter(
    ...
    class ItemViewHolder(
        ...
        fun bind(item: Item) {
            ...
            twoListItem.setContentDescription(context.getString(com.schoolonair.wallet.component.resources.R.string.downloadsMoreOptionsContentDescription, item.downloadItem.fileName))
            ...
            val subtitle = when {
                ...
                else -> context.getString(com.schoolonair.wallet.component.resources.R.string.downloadsStateInProgress)
            }
            twoListItem.setSubtitle(subtitle)
            twoListItem.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_file)
        ...
        private fun showPopupMenu(anchor: View, item: Item) {
            val popupMenu = PopupMenu(layoutInflater, R.layout.popup_window_download_item_menu)
