...
import com.mangala.widget.WidgetTheme
import com.schoolonair.wallet.browser.app.R
import com.schoolonair.wallet.browser.app.databinding.ActivityWidgetConfigurationBinding
import org.koin.android.ext.android.inject

class WidgetThemeConfiguration : MangalaBrowserActivity() {
        ...
        binding.widgetConfigThemeRadioGroup.setOnCheckedChangeListener { _, radioId ->
            when (radioId) {
                R.id.widgetConfigThemeSystem -> {
                    val currentNightMode = resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK
                    if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
                        binding.widgetConfigPreview.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.search_favorites_widget_dark_preview)
                    } else {
                        binding.widgetConfigPreview.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.search_favorites_widget_preview)
                    }
                }
