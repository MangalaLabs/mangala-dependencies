...
package com.mangala.app.global.view
...
import com.schoolonair.wallet.browser.app.databinding.ContentDaxDialogBinding
...
class TypewriterDaxDialog : DialogFragment(R.layout.content_dax_dialog), DaxDialog {
    ...
    private fun setDialog() {
        ...
        context?.let {
            val toolbarColor = if (toolbarDimmed) getColor(it, com.schoolonair.wallet.component.resources.R.color.dimmed) else getColor(it, android.R.color.transparent)
            with(binding) {
