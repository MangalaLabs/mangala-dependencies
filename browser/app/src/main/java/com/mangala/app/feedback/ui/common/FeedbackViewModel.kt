...
import com.mangala.app.feedback.ui.common.Command.Exit
import com.mangala.app.feedback.ui.common.FragmentState.InitialAppEnjoymentClarifier
import com.mangala.app.feedback.ui.common.FragmentState.NegativeFeedbackMainReason
import com.mangala.app.feedback.ui.common.FragmentState.NegativeFeedbackSubReason
import com.mangala.app.feedback.ui.common.FragmentState.NegativeOpenEndedFeedback
import com.mangala.app.feedback.ui.common.FragmentState.NegativeWebSitesBrokenFeedback
import com.mangala.app.feedback.ui.common.FragmentState.PositiveFeedbackFirstStep
import com.mangala.app.feedback.ui.common.FragmentState.PositiveShareFeedback
...
class FeedbackViewModel (
    ...
    init {
        updateViewCommand.postValue(
            UpdateViewCommand(fragmentViewState = InitialAppEnjoymentClarifier(
                NAVIGATION_FORWARDS
            ))
        )
    }
    ...
    fun onBackPressed() {
        ...
        when (currentViewState.fragmentViewState) {
            ...
            is PositiveFeedbackFirstStep -> {
                updateViewCommand.value = currentViewState.copy(fragmentViewState = InitialAppEnjoymentClarifier(
            ...
            is PositiveShareFeedback -> {
                ...
                if (canShowRatingsButton()) {
                    updateViewCommand.value = currentViewState.copy(fragmentViewState = PositiveFeedbackFirstStep(
                        NAVIGATION_BACKWARDS
                    ))
                } else {
                    updateViewCommand.value = currentViewState.copy(fragmentViewState = InitialAppEnjoymentClarifier(
            ...
            is NegativeFeedbackSubReason -> {
                updateViewCommand.value = currentViewState.copy(fragmentViewState = NegativeFeedbackMainReason(
                    NAVIGATION_BACKWARDS
                ))
            }
