...
package com.mangala.app.browser.ui
...
class HttpAuthenticationDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        informationText.text = getString(com.schoolonair.wallet.component.resources.R.string.authenticationDialogMessage, url)

        val alertBuilder = AlertDialog.Builder(requireActivity())
            .setView(rootView)
            .setPositiveButton(com.schoolonair.wallet.component.resources.R.string.authenticationDialogPositiveButton) { _, _ ->
            ...
            }.setNegativeButton(com.schoolonair.wallet.component.resources.R.string.authenticationDialogNegativeButton) { _, _ ->
                rootView.hideKeyboard()
                listener?.cancelAuthentication(request)
                didUserCompleteAuthentication = true
            }
            .setTitle(com.schoolonair.wallet.component.resources.R.string.authenticationDialogTitle)
