...
import com.mangala.mobile.android.ui.Theming
import com.schoolonair.wallet.browser.app.databinding.ItemTrackerNetworkElementBinding
import com.schoolonair.wallet.browser.app.databinding.ItemTrackerNetworkHeaderBinding
import java.util.*
    ...
    private fun onBindHeader(
        ...
        holder.apply {
            ...
            if (iconResource != null) {
                ...
                val drawable = Theming.getThemedDrawable(
                    context,
                    com.schoolonair.wallet.component.resources.R.drawable.other_tracker_privacy_dashboard_bg,
                    MangalaTheme.LIGHT
                )
