...
import com.mangala.app.referral.*
import com.mangala.app.referral.AppInstallationReferrerStateListener
import com.mangala.app.referral.EmptyReferrerStateListener
...
val storeReferralModule = module {
    single { EmptyReferrerStateListener() }
    single { get<EmptyReferrerStateListener>() as AtbInitializerListener }
    single { get<EmptyReferrerStateListener>() as AppInstallationReferrerStateListener }
}
