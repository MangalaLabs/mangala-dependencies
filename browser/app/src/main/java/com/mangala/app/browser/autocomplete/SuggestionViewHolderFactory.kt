...
package com.mangala.app.browser.autocomplete
...
import com.schoolonair.wallet.browser.app.databinding.ItemAutocompleteBookmarkSuggestionBinding
import com.schoolonair.wallet.browser.app.databinding.ItemAutocompleteNoSuggestionsBinding
import com.schoolonair.wallet.browser.app.databinding.ItemAutocompleteSearchSuggestionBinding
...
class EmptySuggestionViewHolderFactory : SuggestionViewHolderFactory {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): AutoCompleteViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return AutoCompleteViewHolder.EmptySuggestionViewHolder(
            ItemAutocompleteNoSuggestionsBinding.inflate(
                inflater,
                parent,
                false
            )
...
sealed class AutoCompleteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    class SearchSuggestionViewHolder(val binding: ItemAutocompleteSearchSuggestionBinding) : AutoCompleteViewHolder(binding.root) {
        fun bind(
            ...
            val phraseOrUrlImage = if (item.isUrl) com.schoolonair.wallet.component.resources.R.drawable.ic_globe_24dp else com.schoolonair.wallet.component.resources.R.drawable.ic_loupe_24dp
