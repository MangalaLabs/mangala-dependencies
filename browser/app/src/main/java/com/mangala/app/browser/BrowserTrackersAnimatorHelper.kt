...
class BrowserTrackersAnimatorHelper {
    ...
    private fun createAnimatedDrawable(context: Context): AnimatedVectorDrawableCompat? {
        return AnimatedVectorDrawableCompat.create(context, com.schoolonair.wallet.component.resources.R.drawable.network_cross_anim)
    }
    ...
    private fun createFrameLayoutContainer(context: Context): FrameLayout {
        ...
        frameLayout.setBackgroundResource(com.schoolonair.wallet.component.resources.R.drawable.background_tracker_logo)
        return frameLayout
    }
...
sealed class TrackerLogo(val resId: Int) {
    ...
    class LetterLogo(
        ...
        resId: Int = com.schoolonair.wallet.component.resources.R.drawable.other_tracker_bg
    ) : TrackerLogo(resId)

    class StackedLogo(resId: Int = com.schoolonair.wallet.component.resources.R.drawable.other_tracker_bg) : TrackerLogo(resId)
}
