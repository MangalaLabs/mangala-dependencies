...
package com.mangala.app.referral

import com.mangala.app.referral.ParsedReferrerResult.CampaignReferrerFound
import com.mangala.app.referral.ParsedReferrerResult.EuAuctionReferrerFound
import com.mangala.app.referral.ParsedReferrerResult.ReferrerNotFound
...
class QueryParamReferrerParser: AppInstallationReferrerParser {
    ...
    private fun extractEuAuctionReferrer(referrerParts: List<String>): ParsedReferrerResult {
        ...
        for (part in referrerParts) {
            ...
            if (part.startsWith(INSTALLATION_SOURCE_KEY) && part.endsWith(
                    INSTALLATION_SOURCE_EU_AUCTION_VALUE
                )) {
