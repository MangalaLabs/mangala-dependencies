...
package com.mangala.app.browser.logindetection

import android.net.Uri
import androidx.core.net.toUri
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.mangala.app.browser.WebNavigationStateChange
...
import com.mangala.app.global.ValidUrl
import com.mangala.app.global.baseHost
import com.mangala.app.global.getValidUrl
...
class NextPageLoginDetection (
    ...
    private fun detectLogin(forwardedToUrl: String): LoginResult {
        ...
        if (authDetectedHosts.any { forwardedToUri.baseHost.contains(it) }) return LoginResult.AuthFlow(
            forwardedToUri.baseHost
        )
