...
import com.schoolonair.wallet.browser.app.databinding.ViewBookmarkFolderEntryBinding
import com.schoolonair.wallet.browser.app.databinding.ViewSavedSiteSectionTitleBinding
...
sealed class BookmarkFolderScreenViewHolders(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    class SectionTitle(private val binding: ViewSavedSiteSectionTitleBinding) : BookmarkFolderScreenViewHolders(binding.root) {
        fun bind() {
            binding.savedSiteSectionTitle.setText(com.schoolonair.wallet.component.resources.R.string.bookmarksSectionTitle)
        }
    }
    ...
    class BookmarkFoldersViewHolder(
        ...
        fun update(bookmarkFolder: BookmarkFolder) {
            ...
            if (totalItems == 0) {
                binding.subtitle.text = context.getString(com.schoolonair.wallet.component.resources.R.string.bookmarkFolderEmpty)
            } else {
                binding.subtitle.text = context.resources.getQuantityString(com.schoolonair.wallet.component.resources.R.plurals.bookmarkFolderItems, totalItems, totalItems)
            }

            binding.icon.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_folder)
