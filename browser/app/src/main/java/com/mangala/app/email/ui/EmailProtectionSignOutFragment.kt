...
import com.schoolonair.wallet.browser.app.databinding.FragmentEmailProtectionSignOutBinding
import kotlinx.coroutines.flow.launchIn
import kotlinx.coroutines.flow.onEach
import org.koin.androidx.viewmodel.ext.android.viewModel


class EmailProtectionSignOutFragment : EmailProtectionFragment() {

    private val viewModel: EmailProtectionSignOutViewModel by viewModel()

    private val binding: FragmentEmailProtectionSignOutBinding by viewBinding()

    private val contactUsSpan = object : MangalaClickableSpan() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_email_protection_sign_out, container, false)
    }
    ...
    private fun setClickableSpan() {
        context?.let {
            val htmlString = getString(com.schoolonair.wallet.component.resources.R.string.emailProtectionSignOutFooter).html(it)
