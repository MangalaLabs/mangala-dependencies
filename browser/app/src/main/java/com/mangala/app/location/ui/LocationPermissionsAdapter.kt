...
import com.schoolonair.wallet.browser.app.databinding.*
...
class LocationPermissionsAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            ...
            DIVIDER_TYPE -> {
                LocationPermissionsViewHolder.LocationPermissionsSimpleViewViewHolder(
                    SectionDivider(
                        parent.context
                    )
                )
            ...
            DENIED_SITES_SECTION_TITLE_TYPE -> {
                val binding = ViewLocationPermissionsSectionTitleBinding.inflate(inflater, parent, false)
                binding.locationPermissionsSectionTitle.setText(com.schoolonair.wallet.component.resources.R.string.preciseLocationDeniedSitesSectionTitle)
...
sealed class LocationPermissionsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    class LocationPermissionsAllowedSectionViewHolder(private val binding: ViewLocationPermissionsSectionTitleBinding) :
        ...
        fun bind(allowedPermissions: Boolean) {
            binding.locationPermissionsSectionTitle.setText(com.schoolonair.wallet.component.resources.R.string.preciseLocationAllowedSitesSectionTitle)
    ...
    class LocationPermissionsItemViewHolder(
        ...
        fun bind(entity: LocationPermissionEntity) {
            ...
            singleListItem.contentDescription = context.getString(
                com.schoolonair.wallet.component.resources.R.string.preciseLocationDeleteContentDescription,
                website
            )
