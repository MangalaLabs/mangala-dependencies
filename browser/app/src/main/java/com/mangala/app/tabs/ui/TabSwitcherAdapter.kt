...
import com.mangala.app.browser.tabpreview.TabEntityDiffCallback
import com.mangala.app.browser.tabpreview.TabEntityDiffCallback.Companion.DIFF_KEY_PREVIEW
import com.mangala.app.browser.tabpreview.TabEntityDiffCallback.Companion.DIFF_KEY_TITLE
import com.mangala.app.browser.tabpreview.TabEntityDiffCallback.Companion.DIFF_KEY_VIEWED
import com.mangala.app.browser.tabpreview.WebViewPreviewPersister
import com.mangala.app.global.image.GlideApp
import com.mangala.app.global.image.GlideRequests
import com.mangala.mobile.android.ui.view.show
import com.mangala.app.tabs.model.TabEntity
import com.mangala.app.tabs.ui.TabSwitcherAdapter.TabViewHolder
import com.schoolonair.wallet.browser.app.databinding.ItemTabBinding
...
class TabSwitcherAdapter(
    ...
    private fun extractTabTitle(
        ...
        title = title.removeSuffix(MANGALA_TITLE_SUFFIX)
        return title
    }
    ...
    companion object {
        private const val MANGALA_TITLE_SUFFIX = "at Mangala"
    }
