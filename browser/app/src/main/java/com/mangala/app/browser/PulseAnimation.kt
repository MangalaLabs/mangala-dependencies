...
import com.mangala.mobile.android.ui.view.setAllParentsClip
...
class PulseAnimation(private val lifecycleOwner: LifecycleOwner) : DefaultLifecycleObserver {
    ...
    private fun addHighlightView(targetView: View): View {
        ...
        highlightImageView.setImageResource(com.schoolonair.wallet.component.resources.R.drawable.ic_circle_pulse_blue)
