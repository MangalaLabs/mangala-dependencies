...
package com.mangala.app.global.image
...
@Excludes(com.alphawallet.app.entity.AlphaWalletGlideModule::class)
@GlideModule
class GlobalGlideModule : AppGlideModule() {
    ...
    private fun getGlideUserAgent(context: Context): String {
        return "DuckDuckGo/${ConstantBrowser.VERSION_NAME.split(".").first()} " +
