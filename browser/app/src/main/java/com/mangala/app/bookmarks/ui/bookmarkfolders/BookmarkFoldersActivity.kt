...
import com.schoolonair.wallet.browser.app.databinding.ActivityBookmarkFoldersBinding
import org.koin.androidx.viewmodel.ext.android.viewModel

class BookmarkFoldersActivity : MangalaBrowserActivity() {

    private lateinit var binding: ActivityBookmarkFoldersBinding
    private lateinit var adapter: BookmarkFolderStructureAdapter

    private val viewModel: BookmarkFoldersViewModel by viewModel()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupToolbar(binding.appBarLayout.findViewById(R.id.toolbar))
        observeViewModel()
        setupAdapter()
        ...
        viewModel.fetchBookmarkFolders(
            ...
            getString(com.schoolonair.wallet.component.resources.R.string.bookmarksSectionTitle),
    ...
    private fun setNewlyCreatedSelectedFolderResult() {
        viewModel.newFolderAdded(
            rootFolderName = getString(com.schoolonair.wallet.component.resources.R.string.bookmarksSectionTitle),
