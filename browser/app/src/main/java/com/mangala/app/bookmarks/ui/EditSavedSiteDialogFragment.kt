...
class EditSavedSiteDialogFragment : SavedSiteDialogFragment() {
    ...
    override fun configureUI() {
        ...
        if (getSavedSite() is SavedSite.Favorite) {
            setToolbarTitle(getString(com.schoolonair.wallet.component.resources.R.string.favoriteDialogTitleEdit))
        } else {
            setToolbarTitle(getString(com.schoolonair.wallet.component.resources.R.string.bookmarkDialogTitleEdit))
