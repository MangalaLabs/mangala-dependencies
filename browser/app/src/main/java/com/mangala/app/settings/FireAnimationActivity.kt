...
import com.mangala.mobile.android.ui.view.setAndPropagateUpFitsSystemWindows
import com.mangala.mobile.android.ui.view.show
import com.mangala.mobile.android.ui.viewbinding.viewBinding
import com.schoolonair.wallet.browser.app.databinding.ActivityFireAnimationBinding

class FireAnimationActivity : MangalaBrowserActivity() {
    ...
    private fun configureFireAnimationView(
        ...
        fireAnimationView.addAnimatorListener(object : Animator.AnimatorListener {
            ...
            override fun onAnimationEnd(animation: Animator) {
                finish()
                overridePendingTransition(0, com.schoolonair.wallet.component.resources.R.anim.tab_anim_fade_out)
            }
        })
    }
