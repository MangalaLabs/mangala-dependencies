...
import com.mangala.app.browser.favicon.FileBasedFaviconPersister.Companion.FAVICON_PERSISTED_DIR
import com.mangala.app.browser.favicon.FileBasedFaviconPersister.Companion.FAVICON_TEMP_DIR
import com.mangala.app.browser.favicon.FileBasedFaviconPersister.Companion.NO_SUBFOLDER
...
import com.mangala.app.global.faviconLocation
import com.mangala.app.global.touchFaviconLocation
import com.mangala.app.global.view.loadFavicon
import com.mangala.app.location.data.LocationPermissionsRepository
import com.mangala.autofill.store.AutofillStore
import kotlinx.coroutines.withContext
import java.io.File

class MangalaFaviconManager (
    ...
    init {
        locationPermissionsRepository.setFaviconManager(this)
        fireproofWebsiteRepository.setFaviconManager(this)
        favoritesRepository.setFaviconManager(this)
    }
