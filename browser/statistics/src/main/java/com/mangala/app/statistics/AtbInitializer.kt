...
class AtbInitializer(
    ...
    private val emptyReferrerStateListener: AtbInitializerListener by inject()

    private val listeners: List<AtbInitializerListener> by lazy { listOf(emptyReferrerStateListener) }
