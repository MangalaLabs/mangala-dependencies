...
import com.mangala.app.statistics.di.getAll
import com.mangala.app.statistics.pixels.Pixel
import com.mangala.app.statistics.pixels.Pixel.PixelParameter.COUNT
import com.mangala.app.statistics.pixels.Pixel.PixelParameter.EXCEPTION_APP_VERSION
import com.mangala.app.statistics.pixels.Pixel.PixelParameter.EXCEPTION_MESSAGE
import com.mangala.app.statistics.pixels.Pixel.PixelParameter.EXCEPTION_TIMESTAMP
import com.mangala.app.statistics.pixels.Pixel.StatisticsPixelName.*
...
class OfflinePixelSender(
    ...
    private val anrOfflinePixelSender: OfflinePixel by inject()

    private val offlinePixels: List<OfflinePixel> by lazy { listOf(anrOfflinePixelSender) }
